...
| C-TC609-HQ-QUALITY-EVAL | C0 | 全国数据标准化技术委员会 | 20256913-T-907 高质量数据集 质量测评规范；2026-09-15 later external recheck 显示 `正在批准`；同日较早 Daily observation 显示 `正在审查`，2026-09-12→2026-09-14 observations 显示 `正在批准`；精确 state_transition sequence/date 未验证 | https://std.samr.gov.cn/gb/search/gbDetailed?id=473E999D3A7837B2E06397BE0A0A2E3E |
...
| C-TC609-EMBODIED-SYNTHETIC | C0 | 全国数据标准化技术委员会 | 20262583-Z-907 具身智能仿真合成数据生成与处理规范；正在起草 | https://std.samr.gov.cn/gb/search/gbDetailed?id=511E762CE9128008E06397BE0A0A41AF |
